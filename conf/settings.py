...
SECRET_KEY = 'django-insecure-zsmy%&$2+r&$)$a4*_0^dgj^4ezp3)53s1s7@w^b9-&=!%l@1)'
...
# Джанго будет записывать электронные сообщения в консоль.
...
EMAIL_PORT = 2525
EMAIL_HOST_USER = "ferdinand-f@mail.ru"
EMAIL_HOST_PASSWORD = "9G6KZb5tDPTqxwFrW7eU"
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
